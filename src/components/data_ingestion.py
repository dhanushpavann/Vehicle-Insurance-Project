...
class DataIngestion:
    ...
    def split_data_as_train_test(self,dataframe: DataFrame) -> None:
        ...
        try:
            ...
            logging.info(
                f"Train file saved at: {self.data_ingestion_config.training_file_path}"
            )

            logging.info(
                f"Test file saved at: {self.data_ingestion_config.testing_file_path}"
            )
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        try:
            ...
            logging.info("Exited initiate_data_ingestion methods and Data_ingestion class")
