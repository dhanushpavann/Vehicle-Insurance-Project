...
class DataTransformation:
    ...
    def get_data_transformer_object(self) -> Pipeline:
        ...
        try:
            ...
            #     ],
            #     remainder='passthrough' #Leaves the other columns as they are
            # )
            preprocessor = ColumnTransformer(
                transformers=[
            ...
            logging.info("Final Preprocessor Pipeline Ready")
            logging.info("Exited the get_transformer_object method of DataTransformation class")
    ...
    def _drop_id_column(self, df):
        ...
        logging.info("Dropping configured columns")
    ...
    def initiate_data_transformation(self) -> DataTransformationArtifact:
        ...
        try:
            ...
            # Ensure train and test have identical columns after dummy encoding
            ...
            logging.info("Transformation done end to end to train-test df, SMOTEEN left to be done")
            ...
            # Test data keeps original distribution (No fit_resample here!)
